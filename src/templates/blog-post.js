  ...
  return (
    <section className="lg:flex h-full">
      ...
      <div className="lg:w-3/4 xl:w-4/5">
        <h1 className="ml-4 lg:ml-0 text-purple-dark mt-8">{title}</h1>
        <div className="ml-4 lg:ml-0 border-t-4 border-purple-dark w-24 mt-4 mb-8" />
        <p className="ml-4 lg:ml-0 mb-8 text-purple font-bold">{description}</p>
